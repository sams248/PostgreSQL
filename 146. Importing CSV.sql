...
\copy navaids (		id,filename, ident, name, type, frequency_khz, latitude_deg, longitude_deg, elevation_ft, iso_country, dme_frequency_khz, dme_channel, dme_latitude_deg, dme_longitude_deg, dme_elevation_ft, slaved_variation_deg,magnetic_variation_deg, usageType, power, associated_airport) FROM '/Users/Sam/Desktop/airportdata/navaids.csv' DELIMITER ',' CSV HEADER;
...
\copy regions (		id,code, local_code, name, continent, iso_country, wikipedia_link, keywords) FROM '/Users/Sam/Desktop/airportdata/regions.csv' DELIMITER ',' CSV HEADER;
...
\copy countries ( id,code, name, continent, wikipedia_link, keywords) FROM '/Users/Sam/Desktop/airportdata/countries.csv' DELIMITER ',' CSV HEADER;
